...
- Portanto, pode-se entender um blockchain, como um estado inicial seguido de um certo número de funções de transição, agrupados em blocos. De fato, o estado atual do json está contido em um blockchain apenas de maneira abstrata, sendo necessário que cada nó determine tal estado partindo do inicial e aplicando as subsequentes transações.